...
public class ccproj2b {
    ...
    static String runInstance(AmazonEC2Client ec2, String imgID,
            String instanceType, String availabilityZone)
            throws InterruptedException {
        // Formulate the Run Instance request.
        RunInstancesRequest runInstancesRequest = new RunInstancesRequest();
        Placement placement =
                new Placement().withAvailabilityZone(availabilityZone);
    ...
    public static void main(String[] args) throws IOException,
        ...
        while (procFreq < 1500) {
            String newInstanceID =
                    runInstance(ec2, "ami-700e4a19", "m1.small", "us-east-1a");
            instanceIDs.add(newInstanceID);
            elbInstances.add(new Instance(newInstanceID));
            instancesCount++;
            System.out.println("No. " + instancesCount + " instance "
                    + newInstanceID + " has been reserved.");
            ...
            System.out
                    .println("Waiting 600 seconds for instances to be registered on ELB...");
            Thread.sleep(600000);
            ...
            ProcessBuilder pb =
                    new ProcessBuilder(scriptName, imgName, totalReqCount,
                            parallelCount, loadBalancerDNS, logPrefix);
            ...
            FileInputStream parsedFile =
                    new FileInputStream("/home/ubuntu/benchmark/" + infoPath);
            BufferedReader fileReader =
                    new BufferedReader(new InputStreamReader(parsedFile));
            ...
            if (benchmarkLine == null) {
                ...
                benchmarkVal =
                        benchmarkLine
                                .substring(24, benchmarkLine.length() - 15);
            }
        ...
        System.out
                .println("Benchmark complete! Minimum number of instances required: "
                        + instancesCount + ".");
        ...
        DeleteLoadBalancerRequest deleteELBRequest =
                new DeleteLoadBalancerRequest("proj2b");
