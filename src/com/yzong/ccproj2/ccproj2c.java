...
public class ccproj2c {
    ...
    public static void main(String[] args) throws IOException {
        ...
        healthCheck.withInterval(30).withHealthyThreshold(9)
                .withUnhealthyThreshold(2).withTarget("HTTP:8080/upload")
                .withTimeout(5);
        ...
        launchConfigRequest.withLaunchConfigurationName("proj2c-launchconfig")
                .withImageId("ami-2b7b2c42").withInstanceType("m1.small")
                .withSecurityGroups("All").withKeyName("jimmy@thinkpad t430");
        asc.createLaunchConfiguration(launchConfigRequest);
        System.out.println("  Done!");

        // Create an Auto Scaling Group.
        System.out.print("Initializing an Auto Scaling Group...");
        CreateAutoScalingGroupRequest scalingGroupRequest =
                new CreateAutoScalingGroupRequest();
        scalingGroupRequest.withAutoScalingGroupName("proj2c-autoscaling")
                .withAvailabilityZones("us-east-1a").withDesiredCapacity(2)
                .withHealthCheckGracePeriod(60)
                .withLoadBalancerNames("proj2c-lb").withMinSize(2)
                .withMaxSize(5)
        ...
        scaleOutRequest.withScalingAdjustment(1)
                .withAdjustmentType("ChangeInCapacity")
                .withPolicyName("ScaleOut")
                .withAutoScalingGroupName("proj2c-autoscaling");
        // ScaleIn is for removing one instance from the group.
        PutScalingPolicyRequest scaleInRequest = new PutScalingPolicyRequest();
        scaleInRequest.withScalingAdjustment(-1)
                .withAdjustmentType("ChangeInCapacity")
                .withPolicyName("ScaleIn")
                .withAutoScalingGroupName("proj2c-autoscaling");
        PutScalingPolicyResult scaleOutResult =
                asc.putScalingPolicy(scaleOutRequest);
        PutScalingPolicyResult scaleInResult =
                asc.putScalingPolicy(scaleInRequest);
        ...
        PutMetricAlarmRequest scaleOutAlarmRequest =
                new PutMetricAlarmRequest();
        List<String> scaleOutARNs = new ArrayList<String>();
        scaleOutARNs.add(emailingARN);
        scaleOutARNs.add(scaleOutPolicyARN);
        scaleOutAlarmRequest.withActionsEnabled(true)
                .withAlarmName("scaleOutAlarm")
                .withComparisonOperator("GreaterThanThreshold")
                .withMetricName("CPUUtilization").withThreshold(80.0)
                .withPeriod(60).withEvaluationPeriods(5)
                .withNamespace("AWS/EC2").withStatistic("Average")
                .withUnit("Percent").withAlarmActions(scaleOutARNs);
        ...
        scaleInAlarmRequest.withActionsEnabled(true)
                .withAlarmName("scaleInAlarm")
                .withComparisonOperator("GreaterThanThreshold")
                .withMetricName("CPUUtilization").withThreshold(20.0)
                .withPeriod(60).withEvaluationPeriods(5)
                .withNamespace("AWS/EC2").withStatistic("Average")
                .withUnit("Percent").withAlarmActions(scaleInARNs);
